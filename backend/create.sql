...
alter table if exists tb_game add constraint fk_genre_id foreign key (genre_id) references tb_genre;
alter table if exists tb_record add constraint fk_game_id foreign key (game_id) references tb_game;
